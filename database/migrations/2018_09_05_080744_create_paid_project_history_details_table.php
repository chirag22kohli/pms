...
class CreatePaidProjectHistoryDetailsTable extends Migration {
     ...
     */
    public function up() {
        Schema::create('paid_project_history_details', function (Blueprint $table) {
            $table->increments('id');
    ...
    public function down() {
        Schema::dropIfExists('paid_project_history_details');
    }
