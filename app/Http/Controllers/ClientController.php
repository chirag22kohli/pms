...
class ClientController extends Controller {
    ...
    public function getPaidProjectGraphData() {
        ...
        $data = DB::select('SELECT paid_price , DATE_FORMAT(created_at,"%d") as dd, Month(created_at), Year(created_at) FROM `paid_project_history_details` where project_admin_id = ? GROUP BY  MONTH(created_at)',[Auth::id()]); 
