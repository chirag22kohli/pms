        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/plans/create') }}" class="btn btn-success btn-sm" title="Add New Plan">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        {!! Form::open(['method' => 'GET', 'url' => '/plans', 'class' => 'form-inline my-2 my-lg-0 float-right', 'role' => 'search'])  !!}
