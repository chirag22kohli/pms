            ...
            <div class="form-group  cls-file">
                <div class="Radio " style="width:100%;">
                    <label class="cls-file">
                        <input type="radio" name="f_default" id="f_default" value ="default" <?php if (!isset($objectAction->trigger) || empty($objectAction->trigger) || $objectAction->trigger == 'default') {
    echo 'checked';
} ?>>
...
<!--li style="list-style:none;" id="image_preview_dummy_f"><img id="image_fb" src="img/noimage.png" style="width:25%;float:right;" /></li-->
            ...
            <div class="form-group ">
                <div class="Radio cls-file" style="width:100%;">
                    <input style ="display:none;"  type = "file"   name ="get_social_facebook" id="get_social_google"  class="fileUpload" accept="image/*">
                    <label><input type="radio"  <?php if (isset($objectAction->trigger) && !empty($objectAction->trigger) && $objectAction->trigger == 'custom') {
    echo 'checked';
} ?>  value ="custom" name="f_default" id="f_custom" onclick="open_google_image()"><span>Custom Image</span></label>
                </div> 
            </div>
            <div class="form-group">
